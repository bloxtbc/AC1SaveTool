...
void SaveWriter::writeObject(
    BinaryWriter& writer,
    const SaveGameObject& object
)
{
...
)
{
    ...
    {
        const auto& payload =
            std::get<PropertyType01>(property.payload);
    ...
    {
        const auto& payload =
            std::get<PropertyType02>(property.payload);
    ...
    {
        const auto& payload =
            std::get<PropertyType03>(property.payload);
    ...
    {
        const auto& payload =
            std::get<PropertyType04>(property.payload);
    ...
    {
        const auto& payload =
            std::get<PropertyType05>(property.payload);
    ...
    {
        const auto& payload =
            std::get<PropertyType06>(property.payload);
...
)
{
    ...
    case SerializerFieldType::Bool:
    {
        ...
        if (!data) {
            throw std::runtime_error(
                "PropertyValue type mismatch: Bool"
            );
        }
    ...
    case SerializerFieldType::Int8Alt2:
    {
        ...
        if (!data) {
            throw std::runtime_error(
                "PropertyValue type mismatch: Int8"
            );
        }
    ...
    case SerializerFieldType::Int16:
    {
        ...
        if (!data) {
            throw std::runtime_error(
                "PropertyValue type mismatch: Int16"
            );
        }
    ...
    case SerializerFieldType::UInt32Alt2:
    {
        ...
        if (!data) {
            throw std::runtime_error(
                "PropertyValue type mismatch: UInt32"
            );
        }
    ...
    case SerializerFieldType::Float32:
    {
        ...
        if (!data) {
            throw std::runtime_error(
                "PropertyValue type mismatch: Float32"
            );
        }
    ...
    case SerializerFieldType::UInt64:
    {
        ...
        if (!data) {
            throw std::runtime_error(
                "PropertyValue type mismatch: UInt64"
            );
        }
    ...
    case SerializerFieldType::Float64:
    {
        ...
        if (!data) {
            throw std::runtime_error(
                "PropertyValue type mismatch: Float64"
            );
        }
    ...
    {
        const auto* data =
            std::get_if<Vector2>(&value.data);

        if (!data) {
            throw std::runtime_error(
                "PropertyValue type mismatch: Vector2"
            );
        }
    ...
    {
        const auto* data =
            std::get_if<Vector3>(&value.data);

        if (!data) {
            throw std::runtime_error(
                "PropertyValue type mismatch: Vector3"
            );
        }
    ...
    {
        const auto* data =
            std::get_if<Vector4>(&value.data);

        if (!data) {
            throw std::runtime_error(
                "PropertyValue type mismatch: Vector4"
            );
        }
    ...
    {
        const auto* data =
            std::get_if<Matrix3x3>(&value.data);

        if (!data) {
            throw std::runtime_error(
                "PropertyValue type mismatch: Matrix3x3"
            );
        }

        writer.f32be(data->m01.x);
        writer.f32be(data->m01.y);
        writer.f32be(data->m01.z);

        writer.f32be(data->m02.x);
        writer.f32be(data->m02.y);
        writer.f32be(data->m02.z);

        writer.f32be(data->m03.x);
        writer.f32be(data->m03.y);
        writer.f32be(data->m03.z);
    ...
    {
        const auto* data =
            std::get_if<Matrix4x4>(&value.data);

        if (!data) {
            throw std::runtime_error(
                "PropertyValue type mismatch: Matrix4x4"
            );
        }
        ...
        writer.f32be(data->m01.y);
        writer.f32be(data->m01.z);
        writer.f32be(data->m01.w);

        writer.f32be(data->m02.x);
        writer.f32be(data->m02.y);
        writer.f32be(data->m02.z);
        writer.f32be(data->m02.w);

        writer.f32be(data->m03.x);
        writer.f32be(data->m03.y);
        writer.f32be(data->m03.z);
        writer.f32be(data->m03.w);

        writer.f32be(data->m04.x);
        writer.f32be(data->m04.y);
        writer.f32be(data->m04.z);
        writer.f32be(data->m04.w);
    ...
    case SerializerFieldType::String:
    {
        ...
        if (!data) {
            throw std::runtime_error(
                "PropertyValue type mismatch: String"
            );
        }
    ...
    {
        const auto* data =
            std::get_if<std::vector<std::byte>>(&value.data);

        if (!data) {
            throw std::runtime_error(
                "PropertyValue type mismatch: Array"
            );
        }
