...
Property SaveReader::readProperty(BinaryReader& reader)
{
    ...
    case 1:
        property.payload = PropertyType01{
            reader.u32be()
        };
        break;

    case 2:
        property.payload = PropertyType02{
            reader.u32be(),
            reader.u16be(),
            reader.u32be()
        };
    ...
    case 3:
        property.payload = PropertyType03{
            reader.u32be(),
            reader.u16be(),
            reader.u32be(),
            reader.u16be(),
    ...
    case 4:
        property.payload = PropertyType04{
            reader.u32be(),
            reader.u32be(),
            reader.u32be(),
            reader.u32be(),
    ...
    case 5:
        property.payload = PropertyType05{
            reader.u32be(),
            reader.u32be(),
            reader.u32be(),
            reader.u32be(),
    ...
    case 6:
        property.payload = PropertyType06{
            reader.u32be(),
            reader.u32be(),
            reader.u32be(),
            reader.u32be(),
...
PropertyValue SaveReader::readValue(
    BinaryReader& reader,
...
)
{
    ...
    {
        uint32_t length = reader.u32be();

        auto bytes = reader.bytes(length);

        value.data = std::vector<std::byte>(
            bytes.begin(),
            bytes.end()
        );
...
SaveGameObject SaveReader::readObject(BinaryReader& reader)
{
    ...
    for (uint32_t i = 0; i < object.propertyCount; ++i) {
        object.values.push_back(
            readValue(reader, object.pm[i].type())
        );
    }
