...
struct PropertyType04 { uint32_t refId; uint32_t b; uint32_t c; uint32_t d; uint16_t e; uint32_t f; };
struct PropertyType05 { uint32_t refId; uint32_t b; uint32_t c; uint32_t d; uint32_t e; uint32_t f; uint32_t g; };
